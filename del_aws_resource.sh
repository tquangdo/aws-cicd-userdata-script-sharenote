...
# ~~~~~~~~~~~ 1) S3 ~~~~~~~~~~~
aws s3 rm s3://dtq-bucket-sharenote/ --recursive
aws s3api delete-bucket --bucket dtq-bucket-sharenote
...
# ~~~~~~~~~~~ 14) EC2 ~~~~~~~~~~~
## ~~~~~~~~~~~ list SG!!!
instance_id=$(aws ec2 describe-instances --filters "Name=tag:Name,Values=DTQEC2Sharenote2" --query "Reservations[].Instances[].InstanceId" --output text)
...
# ~~~~~~~~~~~ 13) CICD ~~~~~~~~~~~
## ~~~~~~~~~~~ pipeline!!!
aws codepipeline delete-pipeline --name DTQCPipelineSharenote 

## ~~~~~~~~~~~ deploy!!!
aws deploy delete-application --application-name DTQCDeployAppSharenote 

## ~~~~~~~~~~~ build!!!
aws codebuild delete-project --name DTQCBuildSharenote 

## ~~~~~~~~~~~ commit!!!
aws codecommit delete-repository --repository-name dtq-ccommit-sharenote 
